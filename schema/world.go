...
type World struct {
	...
	Sectors map[string]Sector `json:"sectors" binding:"required"`
...
func World_load(path_to_sectors_yaml string, path_to_islands_yaml string, path_to_locations_directory string) World {
	sectors := Sectors_load(path_to_sectors_yaml)
