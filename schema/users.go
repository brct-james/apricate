...
func NewUser(token string, username string, dbs map[string]rdb.Database) *User {
	...
	warehouse := NewWarehouse(username, startLocation, map[string]uint64{"Cabbage Seeds":10,"Shelvis Fig Seeds":10,"Potato":10,"Spectral Grass Seeds": 16,"Fertilizer":100})
